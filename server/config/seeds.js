...
db.once('open', async () => {
  ...
  const sneakers = await Sneaker.insertMany([
    ...
    },
    {
      ...
      imageUrl: '/assets/Nike-Air-Max-1-Anniversary-Red/nikeAirMaxAnniversaryRed.png',
      category: 'Lifestyle',
    ...
    },
    {
      ...
      imageUrl: '/assets/Nike-SB-Dunk-Low-Marty-McFly/nikeSBDunkLowMartyMcFly.png',
    ...
    },
    {
      ...
      imageUrl: '/assets/Jordan-1-Retro-High-OG-Chicago/jordan1RetroHighOGChicago.png',
      category: 'Basketball',
    ...
    },
    {
      ...
      imageUrl: '/assets/Nike-Air-Max-97-Silver-Bullet/nikeAirMax97SilverBullet.png',
      category: 'Lifestyle',
